<%@ page contentType="text/html;charset=UTF-8" %>
    <%@ page import="com.example.shopweb.model.Product" %>
        <%@ page import="java.util.Map" %>
            ...
            <% Product product=(Product) request.getAttribute("product"); String contextPath=request.getContextPath();
                String variantPricesJson="{}" ; if (product !=null && product.getVariantPrices() !=null &&
                !product.getVariantPrices().isEmpty()) { StringBuilder sb=new StringBuilder("{"); boolean first=true;
                for (Map.Entry<String, Double> entry : product.getVariantPrices().entrySet()) {
                if (!first) sb.append(",");
                            ...
                            <div class="info">
                                ...
                                <%-- Giá — sẽ đổi khi chọn size --%>
                                    ...
                                    <%-- Chọn size --%>
                                        <div>
                                            <b>Chọn size:</b><br />
                                            <% if (product.getSizes() !=null) { for (String size : product.getSizes()) {
                                                %>
                                        ...
                                        <%-- Số lượng --%>
                                            ...
                                            <%-- Nút hành động --%>
                                                <div class="btn-group">
                                                    <button class="btn-cart" onclick="addToCart()">🛒 Thêm vào giỏ
                                                        hàng</button>
                        ...
                        <script>
                            ...
                            function addToCart() {
                                ...
                                fetch('<%= contextPath %>/cart?action=add', {
                                    ...
                                    .catch(function () { showToast('✗ Không thể kết nối server'); })
                                    .finally(function () {
                                        btn.disabled = false;
