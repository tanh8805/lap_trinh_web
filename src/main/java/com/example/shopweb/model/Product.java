...
public class Product {
    ...
    public Map<String, Double> getVariantPrices() { return variantPrices; }
    public void setVariantPrices(Map<String, Double> variantPrices) { this.variantPrices = variantPrices; }
